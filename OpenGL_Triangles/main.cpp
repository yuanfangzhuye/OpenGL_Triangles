...
void MakePyramid(GLBatch& pyramidBatch) {
    ...
    */
    ...
    pyramidBatch.MultiTexCoord2f(0, 0, 1);
    pyramidBatch.Vertex3fv(vFrontLeft);
    
    pyramidBatch.MultiTexCoord2f(0, 1.0f, 1.0f);
    pyramidBatch.Vertex3fv(vFrontRight);
    
    //三角形前 = （vApex, vBackRight, vBackLeft）
    pyramidBatch.MultiTexCoord2f(0, 0, 0);
    pyramidBatch.Vertex3fv(vBackLeft);
    
    pyramidBatch.MultiTexCoord2f(0, 1.0f, 0);
    pyramidBatch.Vertex3fv(vBackRight);
    
    pyramidBatch.MultiTexCoord2f(0, 0.5f, 1.0f);
    pyramidBatch.Vertex3fv(vApex);
    
    //三角形左 = （vApex, vBackLeft, vFrontLeft）
    pyramidBatch.MultiTexCoord2f(0, 0, 0);
    pyramidBatch.Vertex3fv(vBackLeft);
    ...
    //三角形后 = （Apex，vFrontLeft，vFrontRight）
    pyramidBatch.MultiTexCoord2f(0, 0, 0);
    pyramidBatch.Vertex3fv(vFrontLeft);
    ...
    //三角形右 = （vApex, vFrontRight, vBackRight）
    pyramidBatch.MultiTexCoord2f(0, 0, 0);
    pyramidBatch.Vertex3fv(vFrontRight);
